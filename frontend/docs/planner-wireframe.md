...
│ Course [ CABS ▾ ]       ☐ Insert shifts schedule   ☐ Delete shifts schedule  [Export] │
├───────────────────────────────┬────────────────────────────────────────────────────────┤
...
- A valid calendar-to-calendar drop sends one atomic drag command carrying both checkbox values.
